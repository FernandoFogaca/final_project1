...
import projectImage from '../image/project.png'; // Importação da imagem
      ...
      <Route
        ...
        element={
          <div className="flex flex-col min-h-screen bg-gray-900 items-center justify-center p-6">
            ...
            <div className="flex flex-col  text-white items-center justify-center bg-gray-800 p-10 rounded-lg shadow-2xl mt-16">
              <h2 className="text-3xl font-bold mb-6">Dashboard</h2>
              <img
                src={projectImage}
                alt="Project"
                className="w-[85%] max-w-[780px] object-cover rounded-xl shadow-2xl"
              />
            </div>
          </div>
        }
